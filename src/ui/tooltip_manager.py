...
_VULGAR: dict[str, list[str]] = {
    ...
    "red_spin": [
        ...
        "Pairs with green, blue, and alpha for full-on RGBA surgery on your textures.",
    ...
    "green_spin": [
        ...
        "Works with red, blue, and alpha. It's called RGBA for a reason. Pay attention.",
    ...
    "alpha_delta_spin": [
        ...
        "Alpha delta. Add transparency or remove it globally. It's not complicated.",
        "Does jack squat unless 'Apply RGBA adjustments' is ticked. Same as the others.",
        "Use this when you want to globally darken or brighten the alpha layer. Power move.",
    ...
    "apply_rgb_check": [
        ...
        "Enable RGBA adjustments. Without this checked, all four channel changes = void.",
        ...
        "Turn this off if you just want alpha fixed and don't need your channels messed with.",
    ],
    "suffix_edit": [
