...
_NORMAL: dict[str, list[str]] = {
    ...
    "collections_tab": [
        "The Collections tab shows all unlockable content — themes, effects, and trail styles.",
        "Green border = unlocked and available to use.  Grey border = still locked.",
        "Locked items show a hint about how to unlock them.",
        "Keep clicking, processing files, and changing settings to unlock more content!",
        "The progress bar at the top shows how many hidden themes you have found so far.",
    ],
    "collections_refresh_btn": [
        "Refresh the collections view to see if anything new has been unlocked.",
        "Unlock status updates automatically when you earn a new theme or effect.",
        "Click this after a long processing session to see your progress.",
        "The button force-rebuilds all the cards from the current settings state.",
        "You can also switch to another tab and back — the view refreshes automatically.",
    ],
    "collections_themes_sub": [
        "Lists all preset themes (always available) and all 22 hidden/unlockable themes.",
        "Green cards are unlocked themes you can select in Settings → Theme.",
        "Grey locked cards show the exact condition needed to unlock each one.",
        "Keep clicking, converting files, and fixing alphas to unlock more themes!",
        "Hidden themes have unique visual styles — angular, bubbly, wavy, icy, etc.",
    ],
    "collections_effects_sub": [
        "Shows all available click particle effects and their unlock conditions.",
        "Most effects are available from the start — a few require unlocking their theme first.",
        "Select an effect in Settings → Mouse & Trail → Click Effect.",
        "Locked effects show which theme you need to unlock to gain access.",
        "Green = available. Grey = you need to unlock the associated theme first.",
    ],
    "collections_trails_sub": [
        "Shows all mouse trail styles available in the app.",
        "The 'Wave' and 'Sparkle' trail styles unlock with the Deep Ocean and Ice Cave themes.",
        "Enable the trail in Settings → Mouse & Trail → Enable mouse trail.",
        "Locked trail styles show the unlock condition right on the card.",
        "Trail styles pair nicely with their matching themes and click effects.",
    ],
}
...
_DUMBED: dict[str, list[str]] = {
    ...
    "collections_tab": [
        "Collections. Where you keep all the cool stuff you've unlocked. Very prestigious.",
        "Green card = you got it. Grey card = you don't have it yet. Collect them all.",
        "Click around, process files, change settings — that's how you unlock things.",
        "Shows every hidden theme, effect, and trail style. Some are not easy to find.",
        "Locked items show exactly what you need to do to unlock them. Like a cheat sheet.",
    ],
    "collections_refresh_btn": [
        "Refresh the collections view. It literally just rebuilds the cards.",
        "Click if you think something should be unlocked but it isn't showing up.",
        "Refreshes unlock status from saved settings. Nothing fancy.",
        "The view auto-refreshes when you switch tabs. This is for manual refreshing.",
        "Refresh. It refreshes. That's the button. That's all it does.",
    ],
    "collections_themes_sub": [
        "Themes tab inside Collections. Preset themes are always available, hidden ones need work.",
        "Green = use it. Grey = earn it. That's the system.",
        "22 hidden themes in total. Some need clicks. Some need certain actions.",
        "Hover over a locked card to see the exact unlock condition.",
        "Preset themes never lock. Hidden themes have unique visual styles.",
    ],
    "collections_effects_sub": [
        "Effects collection. Most are free. A few are locked until you earn the right theme.",
        "Click effects are the particles that explode when you click stuff.",
        "If an effect is grey, unlock its theme first. Then it's yours.",
        "Select effects in Settings → Click Effects. They're unlocked here, set there.",
        "Yes, there are a lot of effects. That's the point.",
    ],
    "collections_trails_sub": [
        "Trail styles collection. Dots, fairy, wave, sparkle. A few need unlocking.",
        "Wave = watery themes. Sparkle = icy themes. Fairy = magical themes. Dots = just dots.",
        "Locked trail styles show what you need to do. Usually unlock a specific theme.",
        "Enable trails in Settings → Mouse & Trail. Then pick your style there.",
        "Trail styles that are greyed out need their theme unlocked first.",
    ],
    "theme_search": [
...
_VULGAR: dict[str, list[str]] = {
    ...
    "collections_tab": [
        "Collections: your trophy room of unlockable bullshit. Keep clicking to fill it up.",
        "Green = you earned that shit. Grey = you haven't. Yet. Maybe. Probably not.",
        "22 hidden themes waiting to be unlocked. Most need you to stop being lazy and use the app.",
        "Every locked card tells you exactly how to unlock it. You have no excuse.",
        "This is where the really good stuff lives. Unlock it or spend your life with defaults.",
    ],
    "collections_refresh_btn": [
        "Refresh the collections. Rebuilds everything. Nothing exciting happens, but it works.",
        "Click this if you just unlocked something and it's not showing yet. It'll update.",
        "Refreshes the unlock status from saved settings. Very low stakes operation.",
        "It auto-refreshes when you switch tabs. This button is for the impatient.",
        "Refresh button. Does a refresh. That's the whole fucking story.",
    ],
    "collections_themes_sub": [
        "Theme collection. Presets = always yours. Hidden ones = earn them, you lazy bastard.",
        "22 hidden themes ranging from 'click 100 times' to 'click 5000 times'. Worth it though.",
        "Green means you have it. Grey means you don't. The difference matters.",
        "Locked themes show the exact unlock condition. No mystery, just work.",
        "Some themes are gorgeous. You'll never know which ones because you haven't unlocked them.",
    ],
    "collections_effects_sub": [
        "Click effects you've earned. Most are unlocked. A few need their theme first.",
        "Effects = the shit that explodes when you click. Yes, some are better than others.",
        "Locked effects need their associated theme unlocked. Get clicking.",
        "You set these in Settings. Collections just shows what you're allowed to use.",
        "Particle effects. Some are fire. Some are ice. One is literally gore. All are excellent.",
    ],
    "collections_trails_sub": [
        "Mouse trail styles you've collected. Wave and Sparkle need unlocking. The others are free.",
        "Trail styles follow your mouse around. Some are subtle. Some are absolutely not.",
        "Wave = ocean vibes. Sparkle = ice queen energy. Fairy = adorable chaos. Dots = classic.",
        "Locked trail styles need their theme. Unlock the theme, get the trail. Simple economy.",
        "Enable trails in Settings → Mouse & Trail. Otherwise this panel is just decorative.",
    ],
    "theme_search": [
