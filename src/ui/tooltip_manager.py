...
_NORMAL: dict[str, list[str]] = {
    ...
    "red_spin": [
        ...
        "Requires 'Apply RGB adjustments' checkbox to be ticked.",
        "Combined with Green and Blue deltas for full colour correction.",
    ...
    "green_spin": [
        ...
        "Works together with Red and Blue adjustments for full colour control.",
    ],
    "blue_spin": [
        ...
        "Combine all three RGB deltas to achieve precise colour-matching.",
    ],
    "apply_rgb_check": [
        "Enable RGB channel adjustments in addition to the alpha processing.",
        "When unchecked, the Red/Green/Blue delta spinboxes have no effect.",
        "Tick this to colour-correct textures while also fixing their alpha.",
        "RGB and alpha adjustments run in sequence — alpha first, then RGB.",
...
_DUMBED: dict[str, list[str]] = {
    ...
    "red_spin": [
        ...
        "Nothing happens unless you also check 'Apply RGB adjustments'. Gotcha.",
        "Works together with green and blue sliders for full color control.",
    ...
    "green_spin": [
        ...
        "Nothing happens unless you also check 'Apply RGB adjustments'.",
        "Works with red and blue for complete color correction.",
    ...
    "apply_rgb_check": [
        "Check this to make the Red/Green/Blue adjustments actually do something.",
        "Without this checked those color spinboxes are just decoration.",
        "Enables color correction on top of alpha fixing. Double the fun.",
        "Alpha changes happen first, then the RGB adjustments. Order matters.",
...
_VULGAR: dict[str, list[str]] = {
    ...
    "red_spin": [
        ...
        "Doesn't do jack shit unless you tick 'Apply RGB adjustments'. Rookie mistake.",
        "Pairs with green and blue for full-on color surgery on your textures.",
        "PS2 textures look weird? Crank this and see. Maybe it helps. Probably not.",
    ],
    "green_spin": [
        "Adjust green. Positive = Shrek mode. Negative = anti-Shrek mode.",
        "This changes the freaking green channel on every pixel. Big deal.",
        "Won't do anything unless 'Apply RGB adjustments' is checked. Read the UI.",
        "Works with red and blue. It's called RGB for a reason. Pay attention.",
        "GameCube textures turning everything into a salad? Maybe fix that here.",
    ],
    "blue_spin": [
        "More blue = your image goes underwater. Less blue = warm and toasty.",
        "Blue channel adjustment. Positive = cold. Negative = less cold. Basic.",
        "Still needs 'Apply RGB adjustments' checked. That checkbox exists for a reason.",
    ...
    "apply_rgb_check": [
        "Flip this on or the RGB spinboxes do absolutely nothing. Not a bug.",
        "Enable RGB adjustments. Without this checked, red/green/blue changes = void.",
        "Check it. Apply it. Watch colors shift. Feel the power.",
        "Alpha changes run first, then the RGB fuckery. Order of operations.",
        "Turn this off if you just want alpha fixed and don't need your colors messed with.",
    ],
    "suffix_edit": [
