...
_DUMBED: dict[str, list[str]] = {
    ...
    "emoji_add_btn": [
        "Click Add and watch your chaotic emoji selection get immortalized in the click effect roster. Simple.",
        "Hit Add to dump your chosen emoji into the active particle pool. It joins the chaos permanently.",
        "Congrats, you've enrolled another degenerate emoji into your personal click-effect militia.",
        "One click. One emoji. Added. Done. Stop staring and start clicking like the particle-enjoyer you are.",
        "The Add button does exactly one thing. Adds the emoji. Revolutionary engineering.",
        "You picked the emoji. You're hovering over Add. THE NEXT STEP IS OBVIOUS.",
        "Click it. Emoji goes in the list. Every click from here spawns that emoji. Is this complicated?",
        "Your emoji collection grows by one. The app becomes 6% more unhinged. You're doing great.",
    ],
    "emoji_clear_btn": [
        "Obliterates your entire emoji list in one click. All those carefully chosen particles: vaporized. Gone.",
        "The nuclear option for your particle roster. One click and every emoji you added is fucking deleted.",
        "You spent precious minutes curating that emoji collection. This button does not give a single shit. It nukes everything.",
        "Clear All: for when you look at your emoji list and think 'this entire situation needs to burn'.",
        "Poof. Empty. Done. Add new ones from the dropdown whenever you're emotionally ready to rebuild.",
        "One click. Total annihilation. The emoji are gone. The memories remain. The list does not.",
        "Your little chaotic emoji army is about to get court-martialed. Click if you're sure.",
        "Fresh slate. No emoji. No particles. Pure emptiness. Add new ones and rise from the ashes, champ.",
    ],
    "bg_drip_check": [
        "Check this and liquid starts constantly dripping down the background of your app. Because normal is boring.",
        "Blood or water falls from the top of the window at all fucking times. Extremely atmospheric.",
        "This adds a continuous drip animation that just runs forever in the background. Gore mode intensifies.",
        "Enable this and the background starts weeping with either blood or water. Art is subjective.",
        "You want blood dripping in the background of your image processor? Of course you do. Check it.",
        "Background drip: the feature that makes guests ask 'wait, is your app bleeding?' Yes. Yes it is.",
        "Pair with the Gore theme and Blood Drip for the single most unhinged background aesthetic possible.",
        "It's totally optional and 100% cosmetic. The drip doesn't do anything to files. It just drips. Forever.",
    ],
    "use_theme_drip": [
        "Enable this and the app auto-picks blood or water drip based on your theme. Smart. Spooky. Effortless.",
        "Gore theme = blood drip. Mermaid theme = water drip. This checkbox makes it automatic. Genius.",
        "With this on, your drip style changes every time you switch themes. Absolutely beautiful automation.",
        "Check it and forget it. The app handles the drip logistics so you can focus on literally anything else.",
        "ON = the theme decides the viscosity of your background decoration. OFF = you decide. Both valid.",
        "It's the drip equivalent of 'Use Theme Trail'. Same concept. Just wetness instead of sparkles.",
        "Uncheck to lock in a specific drip style. Check to let the theme pick its own preferred liquid. Easy.",
        "Your app is now smart enough to know what KIND of liquid should be falling in the background. We've peaked.",
    ],
    "bg_drip_combo": [
        "Pick your poison: blood or water. Literally the two options. That's it. Choose wisely.",
        "Blood Drip = crimson terror tears falling from the top. Water Drip = calming cyan sadness. Your call.",
        "Disabled when Use Theme Drip is on — the theme has decided what fluid fills your background. Respect it.",
        "Blood or water. Two options. If you're paralyzed by this choice, the therapy hotline is elsewhere.",
        "Choose the type of liquid that decorates your alpha-processing software. Sentence of the century.",
        "Blood Drip pairs with Gore. Water Drip pairs with Mermaid. Any questions? No? Good. Pick one.",
        "The drip style selector. Exactly as dramatic as it sounds. Blood or water. Drop falls. Life continues.",
        "Manual drip control. For when the theme's choice isn't bloody enough. Or isn't watery enough.",
    ],
    "bg_flock_check": [
        "Enable this and a flock of emoji periodically flies across the top of your window. Because serenity.",
        "Little emoji bastards will now fly across your screen at regular intervals. It's delightful as fuck.",
        "Check this to unleash a background herd of bats/fairies/fish/whatever across your window. Incredible.",
        "Background flock: emoji fly across the top of the app like they have somewhere to be. They don't. They're decorative.",
        "Bats, fairies, butterflies — all available as background decoration for your IMAGE PROCESSOR. Perfect.",
        "Enable the flock and your app has a living, breathing background population of tiny flying emoji. Peak UI.",
        "They fly from one side to the other, doing absolutely nothing useful. It's the most fun feature in here.",
        "ON = emoji fly across the background. OFF = the background is a lifeless void. Obvious correct choice.",
    ],
    "bg_flock_combo": [
        "Pick which tiny flying creatures haunt your background. Bats? Fish? Fairy dust? Choose your minions.",
        "Eight options ranging from 'cute and whimsical' to 'this app is deeply unhinged'. All valid.",
        "Match Theme auto-assigns the correct flock vibe to your theme. Bat Cave gets bats. No surprises.",
        "Fairies for the fairy theme. Fish for the mermaid theme. Bats for the edgy ones. Stars for nerds.",
        "The flock must be ENABLED (checkbox above this) to see them. Enable first. Then pick. Then marvel.",
        "You are picking which emoji will fly across your image editing software. We've really made something special here.",
        "Bats 🦇 are the correct choice for any dark theme. Stars ⭐ for any space/galaxy theme. Petals for masochists.",
        "Match Theme is the lazy genius option. It just picks the right vibe automatically. Zero effort. Maximum coherence.",
    ],
    "bg_ambient_check": [
        "Enable this and your app background gets a permanent ambient particle animation. Snow, fire, ghosts — pick your poison.",
        "Check this box and something beautiful/spooky/chaotic will perpetually drift in your background. Always.",
        "Background ambient: particles just float and drift behind your app at all times. It's mesmerizing.",
        "Enable this for the most dramatic 'I just wanted to process some images' aesthetic ever conceived.",
        "Snow. Embers. Bubbles. Petals. Your background now tells a story. A completely unnecessary and beautiful story.",
        "Ambient background = things floating around behind the UI forever. Zero performance hit. All the vibes.",
        "Check this and your image processing software becomes an atmospheric visual experience. Very fancy.",
        "Ghost Wisps for the goth crowd. Snow Drift for the zen masters. Neon Flicker for the absolute unhinged.",
    ],
    "bg_ambient_combo": [
        "Seven ambient styles. Snow, embers, cherry blossoms, stars, bubbles, neon flickers, ghost wisps. Pick your aesthetic disaster.",
        "Ember Drift 🔥 is for people who like their software to feel like it's on fire. Which it functionally is.",
        "Snow Drift is the 'I want ambient background particles but with dignity' option. Very tasteful.",
        "Ghost Wisps 👻 makes your image editor feel like a haunted mansion. Absolutely deranged. Highly recommend.",
        "Neon Flicker 🌈 = your app looks like it's having a rave. Best paired with Neon or Rainbow theme.",
        "Shooting Stars ✨ for the romantically inclined. Rising Bubbles 🫧 for the Mermaid-themed chaos goblins.",
        "Sakura Petals 🌸 drift peacefully while you're alpha-fixing game textures at midnight. Full vibe.",
        "The ambient check must be enabled to see this work. Enable. Choose. Experience. Regret nothing.",
    ],
    "tooltip_mode_combo": [
