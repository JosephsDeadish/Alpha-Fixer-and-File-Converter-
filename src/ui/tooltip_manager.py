...
_NORMAL: dict[str, list[str]] = {
    ...
    "clamp_min_spin": [
        ...
        "Set equal to Max to force every pixel to exactly the same alpha value.",
    ...
    "clamp_max_spin": [
        ...
        "Set equal to Min to force every pixel to exactly the same alpha value.",
...
_DUMBED: dict[str, list[str]] = {
    ...
    "clamp_min_spin": [
        ...
        "Set Min and Max the same to make every pixel the same alpha value.",
...
_VULGAR: dict[str, list[str]] = {
    ...
    "clamp_min_spin": [
        ...
        "Set both Min and Max to the same number and every pixel gets that exact alpha. That's the flat-value trick.",
    ...
    "clamp_max_spin": [
        ...
        "Set Max = Min to make every pixel the same fixed alpha value. That's flat mode.",
