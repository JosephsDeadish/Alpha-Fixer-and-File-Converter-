...
_NORMAL: dict[str, list[str]] = {
    ...
    "video_media_add": [
        "Add video clips or still images to the Video Editor timeline.",
        "MP4, WEBM, AVI, MOV and other supported video files can be mixed with image clips.",
        ...
        "Use this first, then reorder clips, trim them, preview, and export.",
    ],
    "video_timeline": [
        "This is the clip timeline for the Video Editor.",
        "Drag clips to reorder them; playback and export follow the order shown here.",
        "Video clips show their frame count and fps once loaded successfully.",
        "Select a clip to adjust its in/out trim points below.",
        "Remove the selected clip here if you want to rebuild the sequence.",
    ],
    "video_trim": [
        ...
        "Only the selected clip is affected — other timeline clips keep their own trim.",
        "The clip info line updates to show the selected media details.",
        "Use trim after loading a clip to cut off lead-in or tail frames.",
    ],
    "video_preview": [
        "Preview the edited timeline here before exporting.",
        "Use the scrubber and transport controls to inspect exact frames.",
        "Preview FPS controls playback speed for preview and exported video timing.",
    ...
    "video_export": [
        ...
        "Export uses the current clip order, trim ranges, filter, and adjustment sliders.",
...
_DUMBED: dict[str, list[str]] = {
    ...
    "video_media_add": [
        ...
        "Yes, it takes actual video files now. MP4s too. Huge technological leap.",
        "You can also add still images and pretend they're cinematic.",
        "Drag media into the timeline if clicking buttons is too physically demanding today.",
    ...
    "video_timeline": [
        ...
        "Select one to trim it. Remove one if you regret your choices.",
    ...
    "video_trim": [
        ...
        "The info label below tells you what clip you're messing with.",
        "Use these sliders after selecting a clip, not before. Time still moves forward.",
    ],
    "video_preview": [
        ...
        "Preview FPS affects playback speed and the exported timing too.",
...
_VULGAR: dict[str, list[str]] = {
    ...
    "video_media_add": [
        "Add your goddamn clips already. Video files, still images, whatever belongs in the timeline.",
        "Yes, MP4 works here. Throw that screen recording bastard in and let the app chew on it.",
